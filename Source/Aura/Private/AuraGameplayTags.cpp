...
#pragma region Damage
	...
	GameplayTags.Fire_Damage = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Damage.Fire"),
...
#pragma region Abilities
	...
	GameplayTags.Abilities_Magic_ArcaneShards = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Magic.ArcaneShards"),
	...
	GameplayTags.Abilities_Type_Offensive = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Offensive None"));

	GameplayTags.Abilities_Type_Passive = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Type.Passive"),
		FString("Passive None"));
#pragma endregion
