...
{
	for (const UCharacterClassInfo* CharacterClassInfo = GetCharacterClassInfo(WorldContextObject); const TSubclassOf<UGameplayAbility> AbilityClass : CharacterClassInfo->CommonAbilities)
	{
